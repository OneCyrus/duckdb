...
void JSONTransformOptions::Serialize(Serializer &serializer) const {
	...
	serializer.WritePropertyWithDefault<bool>(105, "merge_case_insensitive_keys", merge_case_insensitive_keys);
	serializer.WritePropertyWithDefault<bool>(106, "auto_rename_case_insensitive_keys", auto_rename_case_insensitive_keys);
}
...
JSONTransformOptions JSONTransformOptions::Deserialize(Deserializer &deserializer) {
	...
	deserializer.ReadPropertyWithDefault<bool>(105, "merge_case_insensitive_keys", result.merge_case_insensitive_keys);
	deserializer.ReadPropertyWithDefault<bool>(106, "auto_rename_case_insensitive_keys", result.auto_rename_case_insensitive_keys);
	return result;
}
